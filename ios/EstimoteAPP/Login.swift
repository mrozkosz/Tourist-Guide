    ...
    var body: some View {
        ZStack{
            ...
            VStack(alignment: .leading){
                Text("SignIn").padding(.leading, 20).padding(.top, 25)
                    .font(.title)
                    .foregroundColor(Color.gray)
                
                Text("Welcome Back!").padding(.leading, 20)
                    .font(.footnote)
                    .foregroundColor(Color.gray)
                ...
                VStack {
                    ...
                    Text("You dont have an account yet?")
                        ...
                        .foregroundColor(Color.gray)
                        .padding(.top, 5)
                    Text("SignUp").foregroundColor(Color.blue).onTapGesture {
    ...
    var body: some View {
        HStack {
            ...
            TextField(self.placeholder,
                ...
                .accessibility(identifier: self.placeholder.lowercased()+"Field")
                .autocapitalization(.none)
                .padding(.leading,5)
        }
        .overlay(
